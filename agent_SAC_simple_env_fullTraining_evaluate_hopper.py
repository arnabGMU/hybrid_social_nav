...
from gibson2.challenge.test_SAC_simple_env_fullTraining_evaluate_hopper import Challenge
...
def main():
    ...
    # Reward
    parser.add_argument('--calculate_rewards', type=str2bool, default=True)
    ...
    parser.add_argument('--replan_if_collision', type=str2bool, default=True) #replan
    ...
    parser.add_argument('--checkpoint_path', type=str, default="checkpoints/sac_checkpoint_fullTraining_fulldataset_raycast_ep300_new")
    parser.add_argument('--checkpoint_name', type=str, default="fullTraining_fulldataset_raycast_ep300_new_mixEp")
    ...
    parser.add_argument('--robot_visible_to_pedestrians', type=str2bool, default=True) # ROBOT VISIBILITY
    parser.add_argument('--robot_visibility_mix', type=str2bool, default=True) # ROBOT VISIBILITY MIX
    parser.add_argument('--robot_visibility_mix_percentage', type=float, default=0.5) # ROBOT VISIBILITY MIX PERCENTAGE
    parser.add_argument('--episode_max_num_step', type=int, default=500)
    
    parser.add_argument('--write_results', type=str2bool, default=True) #WRITE RESULT
    parser.add_argument('--plot', type=str2bool, default=False) #PLOT
    parser.add_argument('--plot_save', type=str2bool, default=False)
    ...
    parser.add_argument('--hopper', type=str2bool, default=True)
